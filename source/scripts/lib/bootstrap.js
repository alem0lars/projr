  ...
  $.fn.modal = function (option) {
    return this.each(function () {
      var $this = $(this)
          ...
          , options = $.extend({}, $.fn.modal.defaults, $this.data(),
              typeof option == 'object' && option)
      if (!data) {
  ...
  Tooltip.prototype = {
    ...
    constructor: Tooltip, init: function (type, element, options) {
      ...
      this.options.selector ?
          (this._options =
              $.extend({}, this.options, { trigger: 'manual', selector: '' })) :
          this.fixTitle()
    }, getOptions: function (options) {
      options =
          $.extend({}, $.fn[this.type].defaults, options, this.$element.data())
      ...
      if (this.hasContent() && this.enabled) {
        ...
        switch (inside ? placement.split(' ')[1] : placement) {
          ...
          case 'left':
            tp =
            {top: pos.top + pos.height / 2 - actualHeight / 2, left: pos.left
                - actualWidth}
            break
          case 'right':
            tp =
...
!function ($) {
  ...
  Affix.prototype.checkPosition = function () {
    ...
    affix = this.unpin != null && (scrollTop + this.unpin <= position.top) ?
        false : offsetBottom != null && (position.top + this.$element.height()
