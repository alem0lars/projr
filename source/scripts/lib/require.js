  ...
  function newContext(contextName) {
    ...
    function checkLoaded() {
      ...
      if (expired && noLoads.length) {
        ...
        err = makeError('timeout', 'Load timeout for modules: ' + noLoads, null,
            noLoads);
      ...
      while (defQueue.length) {
        ...
        if (args[0] === null) {
          return onError(makeError('mismatch',
              'Mismatched anonymous define() module: ' + args[args.length
                  - 1]));
        } else {
    ...
    context = {
      ...
      makeRequire: function (relMap, options) {
        ...
        mixin(localRequire, {
          ...
          toUrl: function (moduleNamePlusExt) {
            ...
            if (index !== -1) {
              ext =
                  moduleNamePlusExt.substring(index, moduleNamePlusExt.length);
      ...
      onScriptLoad: function (evt) {
        ...
        //to support and still makes sense.
        if (evt.type === 'load' ||
            (readyRegExp.test((evt.currentTarget
                || evt.srcElement).readyState))) {
      ...
      onScriptError: function (evt) {
        ...
        if (!hasPathFallback(data.id)) {
          return onError(makeError('scripterror', 'Script error', evt,
              [data.id]));
        }
      }
    };
